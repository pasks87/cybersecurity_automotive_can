...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set CAN0_PHY_RX [ create_bd_port -dir I CAN0_PHY_RX ]
  set CAN0_PHY_TX [ create_bd_port -dir O CAN0_PHY_TX ]
  set CAN1_PHY_RX [ create_bd_port -dir I CAN1_PHY_RX ]
  set CAN1_PHY_TX [ create_bd_port -dir O CAN1_PHY_TX ]
  set btn [ create_bd_port -dir I btn ]
  set led [ create_bd_port -dir O led ]
  set leds [ create_bd_port -dir O -from 2 -to 0 leds ]

  # Create instance: button_led_0, and set properties
  set block_name button_led
  set block_cell_name button_led_0
  if { [catch {set button_led_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $button_led_0 eq "" } {
  ...
  connect_bd_net -net CAN0_PHY_RX_1 [get_bd_ports CAN0_PHY_RX] [get_bd_pins processing_system7_0/CAN0_PHY_RX]
  connect_bd_net -net CAN1_PHY_RX_1 [get_bd_ports CAN1_PHY_RX] [get_bd_pins processing_system7_0/CAN1_PHY_RX]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_ports leds] [get_bd_pins leds/gpio_io_o]
  connect_bd_net -net btn_1 [get_bd_ports btn] [get_bd_pins button_led_0/button]
  connect_bd_net -net button_led_0_led [get_bd_ports led] [get_bd_pins button_led_0/led]
  connect_bd_net -net processing_system7_0_CAN0_PHY_TX [get_bd_ports CAN0_PHY_TX] [get_bd_pins processing_system7_0/CAN0_PHY_TX]
  connect_bd_net -net processing_system7_0_CAN1_PHY_TX [get_bd_ports CAN1_PHY_TX] [get_bd_pins processing_system7_0/CAN1_PHY_TX]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins leds/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
